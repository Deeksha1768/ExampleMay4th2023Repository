//launch browser-->navigate-->login-->create user-->logout-->close application
...
public class CreateUserScenarioDemo1 {
	...
	{
		try {
			oBrowser.get("http://localhost:81/administration/userlist.do");
			Thread.sleep(5000);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	{
		try {
			oBrowser.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]")).click();
			Thread.sleep(2000);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	{
		try {
			oBrowser.findElement(By.xpath("/html/body/div[1]/div[3]/table/tbody/tr[1]/td[5]/a/div[1]")).click();
			Thread.sleep(2000);
